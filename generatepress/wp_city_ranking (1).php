...
<head>
	...
	<script type='text/javascript' src='<?php echo  get_stylesheet_directory_uri(); ?>/jsx/jquery.js' id='jquery-core-js'></script>
    ...
    <link rel="preload" as="font" href="<?php echo  get_stylesheet_directory_uri(); ?>/fontx/Catamaran-Bold.ttf" crossorigin>

    <link rel="preload" as="font" href="<?php echo  get_stylesheet_directory_uri(); ?>/fontx/fa-solid-900.woff2" crossorigin>
                    ...
                    <ul class="sub-menu">
                        ...
                        <li id="menu-item-12089"
                            class="menu-item menu-item-type-post_type menu-item-object-page menu-item-12089"><a
                                href="https://www.cityranking.co/recommended-resources/">Recommended resources</a></li>
                    </ul>
                </li>
                                            ...
                                            <div class="elementor-element elementor-element-16dea65 stickytest elementor-widget elementor-widget-html"
                                                ...
                                                <div class="elementor-widget-container">
                                                    <div class="scroll-box">
															...
															<form data-sf-form-id='1039'  method='get' class='searchandfilter'
                                                                ...
                                                                <li class="sf-field-post-meta-country"
                                                                    ...
                                                                    <label>
                                                                        <select name="city_country"
                                                                                class="sf-input-select" id="city_country" title="">
                                                                            <option class="sf-level-0 sf-item-0 sf-option-active"
                                                                                    selected="selected"
                                                                ...
                                                                <li class="sf-field-post-meta-healthcare"
                                                                    ...
                                                                    <div data-start-min="0" data-start-max="100"
                                                                        ...
                                                                        <label><input
                                                                                class="sf-input-range-number sf-range-min sf-input-number"
                                                                                min="0" max="100" step="1"
                                                                                name="_sfm_healthcare[]" type="number"
                                                                                value="0" title=""></label> <span
                                                                            class="sf-range-values-seperator"> - </span>
                                                                        <label><input
                                                                                class="sf-input-range-number sf-range-max sf-input-number"
                                                                ...
                                                                <li class="sf-field-post-meta-education"
                                                                    ...
                                                                    <div data-start-min="0" data-start-max="100"
                                                                        ...
                                                                        <label><input
                                                                                class="sf-input-range-number sf-range-min sf-input-number"
                                                                                min="0" max="100" step="1"
                                                                                name="_sfm_education[]" type="number"
                                                                                value="0" title=""></label> <span
                                                                            class="sf-range-values-seperator"> - </span>
                                                                        <label><input
                                                                                class="sf-input-range-number sf-range-max sf-input-number"
                                                                ...
                                                                <li class="sf-field-post-meta-sales_tax"
                                                                    ...
                                                                    <div data-start-min="0" data-start-max="21"
                                                                        ...
                                                                        <label><input
                                                                                class="sf-input-range-number sf-range-min sf-input-number"
                                                                                min="0" max="21" step="1"
                                                                                name="_sfm_sales_tax[]" type="number"
                                                                                value="0" title=""></label> <span
                                                                            class="sf-range-values-seperator"> - </span>
                                                                        <label><input
                                                                                class="sf-input-range-number sf-range-max sf-input-number"
                                                                ...
                                                                <li class="sf-field-post-meta-sound_money"
                                                                    ...
                                                                    <div data-start-min="0" data-start-max="100"
                                                                        ...
                                                                        <label><input
                                                                                class="sf-input-range-number sf-range-min sf-input-number"
                                                                                min="0" max="100" step="1"
                                                                                name="_sfm_sound_money[]" type="number"
                                                                                value="0" title=""></label> <span
                                                                            class="sf-range-values-seperator"> - </span>
                                                                        <label><input
                                                                                class="sf-input-range-number sf-range-max sf-input-number"
                                                                ...
                                                                <li class="sf-field-post-meta-regulation"
                                                                    ...
                                                                    <div data-start-min="0" data-start-max="100"
                                                                        ...
                                                                        <label><input
                                                                                class="sf-input-range-number sf-range-min sf-input-number"
                                                                                min="0" max="100" step="1"
                                                                                name="_sfm_regulation[]" type="number"
                                                                                value="0" title=""></label> <span
                                                                            class="sf-range-values-seperator"> - </span>
                                                                        <label><input
                                                                                class="sf-input-range-number sf-range-max sf-input-number"
                                                                ...
                                                                <li class="sf-field-post-meta-rule_of_law"
                                                                    ...
                                                                    <div data-start-min="0" data-start-max="100"
                                                                        ...
                                                                        <label><input
                                                                                class="sf-input-range-number sf-range-min sf-input-number"
                                                                                min="0" max="100" step="1"
                                                                                name="_sfm_rule_of_law[]" type="number"
                                                                                value="0" title=""></label> <span
                                                                            class="sf-range-values-seperator"> - </span>
                                                                        <label><input
                                                                                class="sf-input-range-number sf-range-max sf-input-number"
                                                                ...
                                                                <li class="sf-field-post-meta-legal_system"
                                                                    ...
                                                                    <div data-start-min="0" data-start-max="100"
                                                                        ...
                                                                        <label><input
                                                                                class="sf-input-range-number sf-range-min sf-input-number"
                                                                                min="0" max="100" step="1"
                                                                                name="_sfm_legal_system[]" type="number"
                                                                                value="0" title=""></label> <span
                                                                            class="sf-range-values-seperator"> - </span>
                                                                        <label><input
                                                                                class="sf-input-range-number sf-range-max sf-input-number"
                                                                ...
                                                                <li class="sf-field-post-meta-average_age"
                                                                    ...
                                                                    <div data-start-min="0" data-start-max="363"
                                                                        ...
                                                                        <label><input
                                                                                ...
                                                                                name="_sfm_average_age[]" type="number"
                                                                                value="0" title=""></label> <span
                                                                            class="sf-range-values-seperator"> - </span>
                                                                        <label><input
                                                                                class="sf-input-range-number sf-range-max sf-input-number"
                                                                ...
                                                                <li class="sf-field-post-meta-pollution"
                                                                    ...
                                                                    <div data-start-min="0" data-start-max="57"
                                                                        ...
                                                                        <label><input
                                                                                class="sf-input-range-number sf-range-min sf-input-number"
                                                                                min="0" max="57" step="1"
                                                                                name="_sfm_pollution[]" type="number"
                                                                                value="0" title=""></label> <span
                                                                            class="sf-range-values-seperator"> - </span>
                                                                        <label><input
                                                                                class="sf-input-range-number sf-range-max sf-input-number"
...
<script src="<?php echo  get_stylesheet_directory_uri(); ?>/jsx/e281f432d8f1c46d96453217a762fa64.js" data-minify="1" defer></script>
</body>
</html>